			...
			<Container>
				<div className="AccountPageConfig">
						...
						<div className="sideBar">
							...
							<Row className="space">
								<ApplyModal
									...
									children={
										<FormGen template={template.file} formfunction={formfunction.importPositions} />
									}
								/>
							</Row>
							<Row className="space">
								<ApplyModal
									...
									children={
										<FormGen template={template.file} formfunction={formfunction.importEmployees} />
									}
								/>
							</Row>
						</div>
					...
					<div className="recentJobs">
						...
						<Container>Recently Posted Jobs</Container>
					</div>
				</div>
			</Container>
		);
